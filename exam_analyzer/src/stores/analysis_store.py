...
topic_dependencies, paper_signatures, dimension_baselines."""

import json
from .base import BaseStore


class AnalysisStore(BaseStore):
    ...
    def log_question_feedback(self, qa_id: int, retrieval_count: int = 0,
        ...
        self._qb_insert("question_feedback",
    ...
    def invalidate_distillation_cache(self, topic: str):
        self._qb_delete("distillation_cache", topic, id_col="topic")
    ...
    def record_evolution(self, kp_id: str, trigger_type: str,
        ...
        self._qb_insert("evolution_history",
    ...
    def clear_checkpoint(self, task_name: str):
        self._qb_delete("analysis_checkpoints", task_name, id_col="task_name")
    ...
    def get_exam_trends(self, kp_id: str = None) -> list[dict]:
        ...
        return self._qb.get_all("exam_trends", order_by="kp_id, year, season")
    ...
    def get_dependencies(self, confidence: str = None) -> list[dict]:
        ...
        return self._qb.get_all("topic_dependencies", order_by="prerequisite")
    ...
    def get_paper_signatures(self) -> list[dict]:
        return self._qb.get_all("paper_signatures")
    ...
    def get_dimension_baselines(self) -> list[dict]:
        return self._qb.get_all("dimension_baselines")

    # -- Paper-level aggregated stats --
